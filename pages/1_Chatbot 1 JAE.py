...
st.set_page_config(
    layout="centered",
    page_title="NP JAE COPs 2014-2024  - Chatbot"
)
# endregion <--------- Streamlit App Configuration --------->

st.title("NP JAE COPs 2014-2024  - Chatbot")
st.text("David Seow, 20 Oct 2024")

form = st.form(key="form")
form.subheader("Prompt")

user_prompt = form.text_area("Enter your query related to JAE COPs and intake of Ngee Ann Polytechnic Courses", height=200)
